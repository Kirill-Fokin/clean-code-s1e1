...
var taskInput=document.querySelector(".new-task__inp");//Add a new task.
...
var createNewTaskElement=function(taskString){
    ...
    // вместо этого label.className='task';
...
var taskCompleted=function(){
    ...
    var listItem=this.parentNode;
    listItem.children[1].classList.add("task__title_completed");
...
//Mark task as incomplete.
    ...
    var listItem=this.parentNode;
    listItem.children[1].classList.remove("task__title_completed");
    incompleteTaskHolder.appendChild(listItem);
    bindTaskEvents(listItem,taskCompleted);
}
